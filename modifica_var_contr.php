...
$titolo = "IdealVilla: Modifier les Variables des documents";

$var_pag = array();
$var_pag[0] = 'contr_cond';
$var_pag[1] = 'torna';
$var_pag[2] = 'cambia_qualcosa';
$var_pag[3] = 'aggiungi_cond';
$var_pag[4] = 'num_se';
$var_pag[5] = 'and_or';
$var_pag[6] = 'num_cond_mod';
$var_pag[7] = 'inizializza';
$var_pag[8] = 'cond_sempre';
$var_pag[9] = 'var_se1';
$var_pag[10] = 'cond1';
$var_pag[11] = 'tipo_val_se1';
$var_pag[12] = 'val_se_txt1';
$var_pag[13] = 'val_se_sel1';
$var_pag[14] = 'azione';
$var_pag[15] = 'oper_str';
$var_pag[16] = 'var_allora';
$var_pag[17] = 'tipo_val_allora';
$var_pag[18] = 'val_allora_txt';
$var_pag[19] = 'val_allora_sel';
$var_pag[20] = 'oper_allora_sel';
$var_pag[21] = 'tipo_val_sost1';
$var_pag[22] = 'val_sost1_txt';
$var_pag[23] = 'val_sost1_sel';
$var_pag[24] = 'tipo_val_sost2';
$var_pag[25] = 'val_sost2_txt';
$var_pag[26] = 'val_sost2_sel';
$var_pag[27] = 'var_trunc';
$var_pag[28] = 'val_trunc';
$var_pag[29] = 'val_trunc2';
$var_pag[30] = 'pos_trunc2';
$var_pag[31] = 'var_oper';
$var_pag[32] = 'var_oper2';
$var_pag[33] = 'operatore';
$var_pag[34] = 'tipo_val_oper';
$var_pag[35] = 'val_oper_txt';
$var_pag[36] = 'val_oper_sel';
$var_pag[37] = 'val_arrotond';
$var_pag[38] = 'var_data';
$var_pag[39] = 'oper_data';
$var_pag[40] = 'subdata';
$var_pag[41] = 'var_data2';
$var_pag[42] = 'oper_giorni';
$var_pag[43] = 'num_giorni';
$var_pag[44] = 'tipo_giorni';
$var_pag[45] = 'tipo_int';
$var_pag[46] = 'var_opdat2';
$var_pag[47] = 'var_opdat3';
$var_pag[48] = 'arr_azz';
$var_pag[49] = 'array';
$var_pag[50] = 'tipo_arr';
$var_pag[51] = 'lista_val';
$var_pag[52] = 'array2';
$var_pag[53] = 'break_cont';
$var_pag[54] = 'val_se_sel2';
$var_pag[55] = 'canc_se';
$var_pag[56] = 'var_pers_elimina';
$var_pag[57] = 'nuova_var_pers';
$var_pag[58] = 'aggiungi_var_pers';
$var_pag[59] = 'solo_contr_cond';
$var_pag[60] = 'nuovo_arr_pers';
$var_pag[61] = 'aggiungi_arr_pers';
$var_pag[62] = 'var_arr';
$var_pag[63] = 'elimina_var_pers';
$var_pag[64] = 'sposta_su';
$var_pag[65] = 'num_cond';
$var_pag[66] = 'salta_a';
$var_pag[67] = 'sposta_giu';
$var_pag[68] = 'elimina_cond';
$var_pag[69] = 'arr_pers_elimina';
$n_var_pag = 70;
$num2 = 0;
if (isset($_POST['num_se'])) $num2 = (int) $_POST['num_se'];
elseif (isset($_GET['num_se'])) $num2 = (int) $_GET['num_se'];
for ($num1 = 2 ; $num1 <= $num2 ; $num1++) {
$var_pag[$n_var_pag++] = "var_se$num1";
$var_pag[$n_var_pag++] = "cond$num1";
$var_pag[$n_var_pag++] = "val_se_txt$num1";
$var_pag[$n_var_pag++] = "tipo_val_se$num1";
$var_pag[$n_var_pag++] = "val_se_sel$num1";
} # fine for $num1
...
$titolo = "HotelDruid: ".mex("Modifica Variabili Documenti",$pag);
...
if (!isset($contr_cond) or controlla_num_pos($contr_cond) == "NO" or $contr_cond < 1) $contr_cond = "";
if ($attiva_contratti_consentiti != "n" and $contratti_consentiti_vett[$contr_cond] != "SI") $contr_cond = "";
if (strcmp((string) $contr_cond,"")) {
...
} # fine if (strcmp((string) $contr_cond,""))
...
} # fine else if (!empty($trad_var[$mess_vett[1]]))
...
if (!empty($canc_se) and $num_se > 1) {
$cambia_qualcosa = "";
$num_se--;
if ($num_se == 1) $cond_sempre = "NO";
} # fine if (!empty($canc_se) and $num_se > 1)
if (!empty($agg_se)) {
$cambia_qualcosa = "";
$num_se++;
} # fine if (!empty($agg_se))
if (isset($num_se) and $num_se > 80) $num_se = 80;
...
if ($num_cond_canc) echo mex("Condizioni eliminate",$pag).": <em>$num_cond_canc</em>.<br><br>";
echo mex("Array personalizzato eliminato",$pag).".<br><br>";
...
if (!empty($var_riserv[$nuova_var_pers]) or substr($nuova_var_pers,0,20) == "campo_personalizzato" or substr($nuova_var_pers,0,23) == "commento_personalizzato" or substr($nuova_var_pers,0,16) == "num_persone_tipo") $continua = "NO";
if ($continua == "SI") {
...
if ($solo_contr_cond and strcmp((string) $contr_cond,"")) {
$tipo = "var$contr_cond";
$contr_cond_esist = esegui_query("select numero from $tablecontratti where numero = '".aggslashdb($contr_cond)."' and tipo $LIKE 'contr%' ");
if (numlin_query($contr_cond_esist) != 1) $continua = "NO";
} # fine if ($solo_contr_cond and strcmp((string) $contr_cond,""))
else $tipo = "var";
if ($continua == "SI") {
...
$ultima_parte = (string) $ultima_parte[(count($ultima_parte) - 1)];
if ($ultima_parte != "" and preg_replace("/[0-9]/","",$ultima_parte) == "") $continua = "NO";
if (!empty($var_riserv[$nuovo_arr_pers])) $continua = "NO";
if ($continua == "SI") {
$tabelle_lock = array("$tablecontratti");
$tabelle_lock = lock_tabelle($tabelle_lock);
...
$solo_contr_cond = "";
$tipo = "vett";
} # fine else if ($solo_contr_cond and strcmp((string) $contr_cond,""))
if ($continua == "SI") {
...
if (!empty($mod_contr_importa) and !empty($contr_cond)) {
$tabelle_lock = array($tablecontratti);
$tabelle_lock = lock_tabelle($tabelle_lock);
if ($contr_imp) {
...
} # fine if (strcmp((string) $contr_imp,""))
if ($contr_imp) {
...
unlock_tabelle($tabelle_lock);
} # fine if (!empty($mod_contr_importa) and !empty($contr_cond))


if (!empty($aggiungi_cond)) {
$mostra_form_iniziale = "NO";
$continua = "SI";
...
if ($inizializza != "rpt" and $inizializza != "inr" and $inizializza != "ind" and $inizializza != "ros" and $inizializza != "rca" and $inizializza != "rpa" and $inizializza != "run" and $inizializza != "rds" and preg_replace("/rar[1-9][0-9]*/","",$inizializza) != "") $continua = "NO";
if (isset($cond_sempre) and strcmp((string) $cond_sempre,"") and $cond_sempre != "SI" and $cond_sempre != "NO") $continua = "NO";
...
if (!isset($cond_sempre) or $cond_sempre != "SI") {
...
} # fine if (!isset($cond_sempre) or $cond_sempre != "SI")
$testo .= "#@?";
if ($azione == "set") {
...
if (strcmp((string) $val_arrotond,"") and !strcmp(str_replace("0","",$val_arrotond),"")) $continua = "NO";
...
if (!strcmp((string) $num_giorni,"") or controlla_num_pos($num_giorni) == "NO") $continua = "NO";
...
if ((!empty($sposta_giu) or !empty($sposta_su)) and $num_cond and !empty($salta_a)) {
$tabelle_lock = array("$tablecontratti");
$tabelle_lock = lock_tabelle($tabelle_lock);
...
if (!empty($sposta_giu) and !empty($sposta_su)) $errore = 1;
unset($cond_vett);
$num_cond_trovato = 0;
$salta_a_trovato = 0;
$tipo_cond = "";
...
if (!empty($sposta_giu) and !$num_cond_trovato and $salta_a_trovato) $errore = 1;
if (!empty($sposta_su) and $num_cond_trovato and !$salta_a_trovato) $errore = 1;
} # fine for $num1
...
} # fine if (!empty($sposta_giu))
if (!empty($sposta_su)) {
for ($num1 = ($pos_num_cond - 1) ; $num1 >= $pos_salta_a ; $num1--) {
esegui_query("update $tablecontratti set numero = '$ultima_cond' where numero = '".$cond_vett[$num1]."' and tipo = 'cond$contr_cond' ");
$ultima_cond = $cond_vett[$num1];
} # fine for $num1
} # fine if (!empty($sposta_su))
esegui_query("update $tablecontratti set numero = '$salta_a' where numero = '-1' and tipo = 'cond$contr_cond' ");
} # fine if (!$errore)
unlock_tabelle($tabelle_lock);
} # fine if ((!empty($sposta_giu) or !empty($sposta_su)) and $num_cond and...
...
$tipo_var_pers = risul_query($variabili_pers,$num1,'tipo');
if ($tipo_var_pers == "var") $option_var_pers_tipo .= "<option value=\"$num_var_pers\">$var_pers (".mex("tutti i documenti",$pag).")</option>";
else $option_var_pers_tipo .= "<option value=\"$num_var_pers\">$var_pers (".mex("documento",$pag)." $contr_cond)</option>";
$var_predef[$num_var_predef] = $var_pers;
$num_var_predef++;
$nome_var[$num_var_pers] = $var_pers;
} # fine for $num1
...
<input class=\"sbutton\" type=\"submit\" name=\"elimina_var_pers\" value=\"".mex("Elimina",$pag)." (".mex("anche condizioni",$pag).")\">";
unset($option_var_pers_tipo);
...
if (!empty($nome_contratto[$num_contr])) $frase_cond_contr .= " (".$nome_contratto[$num_contr].")";
...
if (!empty($nome_contratto[$num_contr])) $opt_contr .= " (".$nome_contratto[$num_contr].")";
$opt_contr .= "</option>";
...
if (empty($num_cond_rip_a['num'][$num_arr_rip])) {
$num_rip_a++;
...
} # fine if (empty($num_cond_rip_a['num'][$num_arr_rip]))
} # fine for $num1

$azione_orig = fixset($azione);
$num_cond_mod_vedi = "";
$condizioni = esegui_query("select * from $tablecontratti where tipo = 'cond$contr_cond' order by testo $LIKE 'ind%' desc, testo $LIKE 'inr%' desc, testo $LIKE 'rpt%' desc, testo $LIKE 'ros%' desc, testo $LIKE 'rca%' desc, testo $LIKE 'rpa%' desc, testo $LIKE 'run%' desc, testo $LIKE 'rds%' desc$ordine_rar, numero");
$num_condizioni = numlin_query($condizioni);
$num_cond_ini_d = 0;
$num_cond_ini_r = 0;
$num_cond_rpt = 0;
...
if (substr($cond,0,3) == "rds") $num_cond_rip_d = $num1 + 1;
if (substr($cond,0,3) == "rar") {
$num_arr_rip = substr($cond,3,(strlen(strstr($cond,"#@?")) * -1));
$num_cond_rip_a[$num_cond_rip_a['num'][$num_arr_rip]] = $num1 + 1;
} # fine if (substr($cond,0,3) == "rar")
if (isset($num_cond) and $n_cond == $num_cond) $num_cond_passa = $num1;
...
if ($num_cond_rip_d < $num_cond_rip_u) $num_cond_rip_d = $num_cond_rip_u;
...
$condizione = explode("#@?",$condizione);
$azione = explode("#%?",$condizione[2]);
if (isset($num_cond_mod) and $num_cond_mod == $num_cond) {
$num_cond_mod_vedi = ($num1 + 1);
$inizializza = $condizione[0];
$azione_orig = $azione[0];
$num_cond_mod_orig = $num_cond_mod;
if (!empty($agg_se) or !empty($canc_se)) $num_cond_mod = "";
} # fine if (isset($num_cond_mod) and $num_cond_mod == $num_cond)

if ($num1 == $num_cond_rpt and $condizione[0] == "ros") echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni degli ospiti",$pag)." (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
if ($num1 == $num_cond_rip_o and $condizione[0] == "rca") echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni dei costi aggiuntivi",$pag)." (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
if ($num1 == $num_cond_rip_c and $condizione[0] == "rpa") echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni dei pagamenti",$pag)." (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
if ($num1 == $num_cond_rip_p and $condizione[0] == "run") echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni delle unità",$pag)." (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
if ($num1 == $num_cond_rip_u and $condizione[0] == "rds") echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni dei documenti salvati",$pag)." (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
if ($num1 == $num_cond_rip_d and $condizione[0] == "rar".$num_cond_rip_a['arr'][1]) echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni dell'array",$pag)." [".$nome_var["a".$num_cond_rip_a['arr'][1]]."] (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
for ($num2 = 1 ; $num2 < $num_rip_a ; $num2++) if ($num1 == $num_cond_rip_a[$num2] and $condizione[0] == "rar".$num_cond_rip_a['arr'][($num2 + 1)]) echo "</table><br>".mex("Condizioni applicate",$pag)." ".mex("solo nelle ripetizioni dell'array",$pag)." [".$nome_var["a".$num_cond_rip_a['arr'][($num2 + 1)]]."] (<em>".mex("tutte le altre condizioni non verranno più applicate in queste ripetizioni",$pag)."</em>):<br><table>";
echo "<tr style=\"background-color: ".rowbgcolor().";\"><td><b>".($num1 + 1)."</b>. ";
if (isset($num_cond_passa) and $num_cond_passa == ($num1 + 20)) echo "<a name=\"condizioni\"></a>";
$str_cond = "";
...
if (strcmp((string) $azione[6],"")) $str_cond .= " (".mex("arrotondato a",$pag)." ".$azione[6].")";
if (isset($num_cond_mod) and $num_cond_mod == $num_cond) {
$var_oper = $azione[1];
$var_oper2 = $azione[2];
$operatore = $azione[3];
...
if (isset($num_cond_mod) and $num_cond_mod == $num_cond) $arr_azz = $azione[1];
...
if (isset($num_cond_mod) and $num_cond_mod == $num_cond) $break_cont = $azione[1];
} # fine if ($azione[0] == "array")
...
if ($condizione[0] == "rds") $str_cond .= " ".mex("solo nelle ripetizioni dei documenti salvati",$pag);
if (substr($condizione[0],0,3) == "rar") $str_cond .= " ".mex("solo nelle ripetizioni dell'array",$pag)." [".$nome_var["a".substr($condizione[0],3)]."]";
echo ucfirst($str_cond).".</td>";
$fine_cond_rip_a = 0;
for ($num2 = 1 ; $num2 <= $num_rip_a ; $num2++) if ($num1 == ($num_cond_rip_a[$num2] - 1)) $fine_cond_rip_a = 1;
if ($num1 != ($num_condizioni - 1) and $num1 != ($num_cond_ini_r - 1) and $num1 != ($num_cond_ini_d - 1) and $num1 != ($num_cond_rpt - 1) and $num1 != ($num_cond_rip_o - 1) and $num1 != ($num_cond_rip_c - 1) and $num1 != ($num_cond_rip_p - 1) and $num1 != ($num_cond_rip_u - 1) and $num1 != ($num_cond_rip_d - 1) and !$fine_cond_rip_a) {
$opt_giu = "";
$fine_opt = $num_condizioni;
for ($num2 = $num_rip_a ; $num2 > 0 ; $num2--) if ($num1 < ($num_cond_rip_a[$num2] - 1)) $fine_opt = $num_cond_rip_a[$num2];
if ($num1 < ($num_cond_rip_d - 1)) $fine_opt = $num_cond_rip_d;
...
echo "<td><form accept-charset=\"utf-8\" method=\"post\" action=\"$pag#condizioni\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
$input_cond_contr
...
if ($num1 != 0 and $num1 != $num_cond_ini_r and $num1 != $num_cond_ini_d and $num1 != $num_cond_rpt and $num1 != $num_cond_rip_o and $num1 != $num_cond_rip_c and $num1 != $num_cond_rip_p and $num1 != $num_cond_rip_u and $num1 != $num_cond_rip_d and !$fine_cond_rip_a) {
$opt_su = "";
$fine_opt = 1;
...
if ($num1 > $num_cond_rip_d) $fine_opt = ($num_cond_rip_d + 1);
...
echo "<td><form accept-charset=\"utf-8\" method=\"post\" action=\"$pag#modcond\"><div>
<input type=\"hidden\" name=\"anno\" value=\"$anno\">
<input type=\"hidden\" name=\"id_sessione\" value=\"$id_sessione\">
$input_cond_contr
...
<input class=\"smallsbutton\" type=\"submit\" name=\"elimina_cond\" value=\"".mex("Elimina",$pag)."\">
 ...
 if (isset($num_cond_mod_orig) and $num_cond_mod_orig == $num_cond) $num_cond_mod = $num_cond_mod_orig;
} # fine for $num1
echo "</table>";
...
if (!empty($nome_contratto[$num_contr])) $opt_contr_imp .= " (".$nome_contratto[$num_contr].")";
...
if (!empty($var_predef_data[$var_predef[$num1]]) or $num1 >= $num_var_predef_orig) $option_var_predef_data .= "<option value=\"".$var_predef[$num1]."\">".mex2($var_predef[$num1])."</option>";
} # fine for $num1


if (empty($num_se)) $num_se = 1;
if ($num_se > 2 and empty($and_or)) $num_se = 1;
$sel_rip = "";
$sel_inirip = "";
$sel_inidoc = "";
$sel_iniros = "";
...
$sel_inirun = "";
$sel_inirds = "";
if (empty($inizializza) or $inizializza == "rpt") $sel_rip = " selected";
else {
...
if ($inizializza == "rds") $sel_inirds = " selected";
} # fine else if (empty($inizializza) or $inizializza == "rpt")
$option_arr_rip = str_replace("\">","\">".mex("solo nelle ripetizioni dell'array",$pag)." ",$option_arr_pers);
if (isset($inizializza) and substr($inizializza,0,3) == "rar") {
...
<option value=\"rds\"$sel_inirds>".mex("solo nelle ripetizioni dei documenti salvati",$pag)."</option>
$option_arr_rip
</select>:<br>
...
if ($num_se == 1) {
if (!isset($cond_sempre) or $cond_sempre != "NO") $checked = " checked";
else $checked = "";
echo "<tr><td>
...
for ($num1 = 1 ; $num1 <= $num_se ; $num1++) {
if ($num_se == 1) {
if (isset($cond_sempre) and $cond_sempre == "NO") $checked = " checked";
else $checked = "";
...
if (isset(${"tipo_val_se".$num1}) and ${"tipo_val_se".$num1} == "var") { $chk_var = " checked"; $chk_txt = ""; }
...
} # fine if (isset(${"cond".$num1}))
echo "<td>$fr_se</td><td><select name=\"var_se$num1\">
".str_replace("\"".fixset(${"var_se".$num1})."\">","\"".fixset(${"var_se".$num1})."\" selected>",$option_var_predef)."
...
<input type=\"text\" name=\"val_se_txt$num1\" value=\"".htmlspecialchars(fixstr(${"val_se_txt".$num1}))."\" size=\"20\" maxlength=\"750\" onfocus=\"document.getElementById('val_se_txt$num1').checked='1'\">
...
".str_replace("\"".fixset(${"val_se_sel".$num1})."\">","\"".fixset(${"val_se_sel".$num1})."\" selected>",$option_var_predef)."
...
if (isset($oper_str) and $oper_str == ".=") { $sel_ug = ""; $sel_div = " selected"; }
else { $sel_ug = " selected"; $sel_div = ""; }
if (isset($tipo_val_allora) and $tipo_val_allora == "var") { $chk_var = " checked"; $chk_txt = ""; }
else { $chk_var = ""; $chk_txt = " checked"; }
if (isset($tipo_val_sost1) and $tipo_val_sost1 == "var") { $chk_var_s1 = " checked"; $chk_txt_s1 = ""; }
else { $chk_var_s1 = ""; $chk_txt_s1 = " checked"; }
if (isset($tipo_val_sost2) and $tipo_val_sost2 == "var") { $chk_var_s2 = " checked"; $chk_txt_s2 = ""; }
...
$sel_oper_eas = "";
$sel_oper_md5 = "";
if (empty($oper_allora_sel)) $sel_oper_no = " selected";
else {
...
} # fine else if (empty($oper_allora_sel))
...
".str_replace("\"".fixset($var_allora)."\">","\"".fixset($var_allora)."\" selected>",$option_var_pers)."
...
<input type=\"text\" name=\"val_allora_txt\" value=\"".htmlspecialchars(fixstr($val_allora_txt))."\" size=\"20\" maxlength=\"750\" onfocus=\"document.getElementById('val_all_txt').checked='1'\">
...
".str_replace("\"".fixset($val_allora_sel)."\">","\"".fixset($val_allora_sel)."\" selected>",$option_var_predef)."
...
<input type=\"text\" name=\"val_sost1_txt\" value=\"".htmlspecialchars(fixstr($val_sost1_txt))."\" size=\"20\" maxlength=\"750\" onfocus=\"document.getElementById('val_s1_txt').checked='1'\">
...
".str_replace("\"".fixset($val_sost1_sel)."\">","\"".fixset($val_sost1_sel)."\" selected>",$option_var_predef)."
</select></td></tr></table></td><td>
".str_replace(" ","&nbsp;",mex("con",$pag))."</td><td>
<b style=\"font-size: 260%;\">{</b></td><td>
<table cellspacing=\"0\"><tr><td>
<input type=\"radio\" id=\"val_s2_txt\" name=\"tipo_val_sost2\" value=\"txt\"$chk_txt_s2></td><td>
<input type=\"text\" name=\"val_sost2_txt\" value=\"".htmlspecialchars(fixstr($val_sost2_txt))."\" size=\"20\" maxlength=\"750\" onfocus=\"document.getElementById('val_s2_txt').checked='1'\">
...
".str_replace("\"".fixset($val_sost2_sel)."\">","\"".fixset($val_sost2_sel)."\" selected>",$option_var_predef)."
</select></td></tr></table>
</td><td>)</td></tr></table><br>";

if ($azione == "trunc") $chk_az = " checked";
else $chk_az = "";
if (isset($pos_trunc2) and $pos_trunc2 == "fin") { $sel_ini = ""; $sel_fin = " selected"; }
...
".str_replace("\"".fixset($var_trunc)."\">","\"".fixset($var_trunc)."\" selected>",$option_var_pers)."
</select></td><td>".str_replace(" ","&nbsp;",mex("dopo",$pag))."
<small><small>(".str_replace(" ","&nbsp;",mex("prima di con valori negativi",$pag)).")</small></small></td><td>
<input type=\"text\" name=\"val_trunc\" value=\"".fixset($val_trunc)."\" size=\"3\" maxlength=\"12\"></td><td>
".str_replace(" ","&nbsp;",mex("caratteri",$pag))."</td><td>
<td>(".str_replace(" ","&nbsp;",mex("se mancanti riempire con",$pag))."</td><td>
<input type=\"text\" name=\"val_trunc2\" value=\"".htmlspecialchars(fixstr($val_trunc2))."\" size=\"10\" maxlength=\"750\"></td>
...
} # fine if (isset($operatore))
if (isset($tipo_val_oper) and $tipo_val_oper == "var") { $chk_var = " checked"; $chk_txt = ""; }
else { $chk_var = ""; $chk_txt = " checked"; }
if (!isset($val_oper_txt) or !strcmp((string) $val_oper_txt,"")) $val_oper_txt = "0";
...
".str_replace("\"".fixset($var_oper)."\">","\"".fixset($var_oper)."\" selected>",$option_var_pers)."
</select></td><td>".str_replace(" ","&nbsp;",mex("uguale a",$pag))."</td><td>
<select name=\"var_oper2\">
".str_replace("\"".fixset($var_oper2)."\">","\"".fixset($var_oper2)."\" selected>",$option_var_predef)."
</select></td><td>
...
".str_replace("\"".fixset($val_oper_sel)."\">","\"".fixset($val_oper_sel)."\" selected>",$option_var_predef)."
</select></td></tr></table>
</td><td>(".str_replace(" ","&nbsp;",mex("arrotondato a",$pag))."</td><td>
<input type=\"text\" name=\"val_arrotond\" value=\"".htmlspecialchars(fixstr($val_arrotond))."\" size=\"15\" maxlength=\"50\"></td><td>)
...
} # fine if (isset($subdata))
$sel_piu = "";
$sel_men = "";
if (isset($oper_giorni)) {
if ($oper_giorni == "+") $sel_piu = " selected";
if ($oper_giorni == "-") $sel_men = " selected";
} # fine if (isset($oper_giorni))
if (!isset($num_giorni) or !strcmp((string) $num_giorni,"")) $num_giorni = "0";
$sel_g = "";
$sel_m = "";
$sel_a = "";
if (isset($tipo_giorni)) {
if ($tipo_giorni == "g") $sel_g = " selected";
if ($tipo_giorni == "m") $sel_m = " selected";
if ($tipo_giorni == "a") $sel_a = " selected";
} # fine if (isset($tipo_giorni))
$sel_ig = "";
$sel_im = "";
$sel_ia = "";
if (isset($tipo_int)) {
...
if (!isset($var_data)) echo $option_var_pers;
else echo str_replace("\"$var_data\">","\"$var_data\" selected>",$option_var_pers);
echo "</select></td><td>".str_replace(" ","&nbsp;",mex("uguale a",$pag))."</td>
<td><b style=\"font-size: 260%;\">{</b></td><td>
<table cellspacing=\"0\"><tr><td>
...
if (!isset($var_data2)) echo $option_var_predef_data;
else echo str_replace("\"$var_data2\">","\"$var_data2\" selected>",$option_var_predef_data);
echo "</select></td><td>
...
<option value=\"g\"$sel_ig>".mex("giorni",$pag)."</option>
<option value=\"m\"$sel_im>".mex("mesi",$pag)."</option>
<option value=\"a\"$sel_ia>".mex("anni",$pag)."</option>
</select></td><td>
".str_replace(" ","&nbsp;",mex("dalla data",$pag))."</td><td>
<select name=\"var_opdat2\">";
if (!isset($var_opdat2)) echo $option_var_predef_data;
else echo str_replace("\"$var_opdat2\">","\"$var_opdat2\" selected>",$option_var_predef_data);
echo "</select></td><td>
".str_replace(" ","&nbsp;",mex("alla data",$pag))."</td><td>
<select name=\"var_opdat3\">";
if (!isset($var_opdat3)) echo $option_var_predef_data;
else echo str_replace("\"$var_opdat3\">","\"$var_opdat3\" selected>",$option_var_predef_data);
...
<select name=\"arr_azz\">
".str_replace("\"".fix_set($arr_azz)."\">","\"$arr_azz\" selected>",$option_arr_pers)."
...
<select name=\"array\">
".str_replace("\"".fix_set($array)."\">","\"$array\" selected>",$opt_arr_var_non_predef)."
</select></td><td>
<b style=\"font-size: 260%;\">{</b></td><td>
<table cellspacing=\"0\">
...
<td><input type=\"text\" name=\"lista_val\" value=\"".htmlspecialchars(fixstr($lista_val))."\" size=\"26\"></td>
...
".str_replace("\"".fix_set($array2)."\">","\"$array2\" selected>",$option_arr_pers)."
...
if (isset($break_cont) and $break_cont == "cont") { $sel_fine = ""; $sel_cont = " selected"; }
...
<input class=\"sbutton\" type=\"submit\" value=\"".mex("Modifica il documento",$pag)." $contr_cond\">
</div></form><br>";
} # fine if ($contr_cond)

...
$pag = "tabella3.php";
$titolo = "HotelDruid: Tableaux Mensuel";

$var_pag = array();
$var_pag[0] = 'mese';
$var_pag[1] = 'anno_succ';
$var_pag[2] = 'tutti_mesi';
$n_var_pag = 3;
...
$titolo = "HotelDruid: ".mex("Tabelle Mesi",$pag);
...
for ($num1 = 0 ; $num1 < $num_colonne ; $num1++) echo "<td style=\"height: 0; padding: 0; border: 0;\"></td><td style=\"height: 0; padding: 0; border: 0;\"></td>";

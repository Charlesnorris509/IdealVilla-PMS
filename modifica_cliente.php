...
$titolo = "IdealVilla: Modification des Clients";

$var_pag = array();
$var_pag[0] = 'idclienti';
$var_pag[1] = 'origine';
$var_pag[2] = 'tipo_tabella';
$var_pag[3] = 'n_cognome';
$var_pag[4] = 'n_nome';
$var_pag[5] = 'n_soprannome';
$var_pag[6] = 'n_sesso';
$var_pag[7] = 'n_nazionalita';
$var_pag[8] = 'n_giornonascita';
$var_pag[9] = 'n_mesenascita';
$var_pag[10] = 'n_annonascita';
$var_pag[11] = 'n_nazionenascita';
$var_pag[12] = 'n_regionenascita';
$var_pag[13] = 'n_cittanascita';
$var_pag[14] = 'n_nazione';
$var_pag[15] = 'n_regione';
$var_pag[16] = 'n_citta';
$var_pag[17] = 'n_via';
$var_pag[18] = 'n_nomevia';
$var_pag[19] = 'n_numcivico';
$var_pag[20] = 'n_cap';
$var_pag[21] = 'n_telefono';
$var_pag[22] = 'n_email';
$var_pag[23] = 'n_lingua_cli';
$var_pag[24] = 'n_tipodoc';
$var_pag[25] = 'n_documento';
$var_pag[26] = 'n_nazionedoc';
$var_pag[27] = 'n_regionedoc';
$var_pag[28] = 'n_cittadoc';
$var_pag[29] = 'n_giornoscaddoc';
$var_pag[30] = 'n_mesescaddoc';
$var_pag[31] = 'n_annoscaddoc';
$var_pag[32] = 'n_fax';
$var_pag[33] = 'n_telefono2';
$var_pag[34] = 'n_telefono3';
$var_pag[35] = 'n_email2';
$var_pag[36] = 'n_email_cert';
$var_pag[37] = 'n_cod_fiscale';
$var_pag[38] = 'n_partita_iva';
$var_pag[39] = 'campo_pers0';
$var_pag[40] = 'campo_pers1';
$var_pag[41] = 'campo_pers2';
$var_pag[42] = 'campo_pers3';
$var_pag[43] = 'campo_pers4';
$var_pag[44] = 'n_commento';
$var_pag[45] = 'd_cognome';
$var_pag[46] = 'd_nome';
$var_pag[47] = 'd_soprannome';
$var_pag[48] = 'd_sesso';
$var_pag[49] = 'd_titolo_cli';
$var_pag[50] = 'd_datanascita';
$var_pag[51] = 'd_documento';
$var_pag[52] = 'd_scadenzadoc';
$var_pag[53] = 'd_tipodoc';
$var_pag[54] = 'd_nazionedoc';
$var_pag[55] = 'd_regionedoc';
$var_pag[56] = 'd_cittadoc';
$var_pag[57] = 'd_cittanascita';
$var_pag[58] = 'd_regionenascita';
$var_pag[59] = 'd_nazionenascita';
$var_pag[60] = 'd_nazionalita';
$var_pag[61] = 'd_nazione';
$var_pag[62] = 'd_regione';
$var_pag[63] = 'd_citta';
$var_pag[64] = 'd_via';
$var_pag[65] = 'd_numcivico';
$var_pag[66] = 'd_telefono';
$var_pag[67] = 'd_telefono2';
$var_pag[68] = 'd_telefono3';
$var_pag[69] = 'd_cod_fiscale';
$var_pag[70] = 'd_partita_iva';
$var_pag[71] = 'd_fax';
$var_pag[72] = 'd_cap';
$var_pag[73] = 'd_email';
$var_pag[74] = 'd_email2';
$var_pag[75] = 'd_email_cert';
$var_pag[76] = 'd_nome_lingua';
$var_pag[77] = 'd_commento';
$var_pag[78] = 'd_num_campi_pers';
$var_pag[79] = 'modifica_cliente';
$var_pag[80] = 'n_titolo_cli';
$var_pag[81] = 'id_nuovo_utente_inserimento';
$var_pag[82] = 'c_nome';
$var_pag[83] = 'c_soprannome';
$var_pag[84] = 'c_titolo_cli';
$var_pag[85] = 'c_datanascita';
$var_pag[86] = 'c_documento';
$var_pag[87] = 'c_scadenzadoc';
$var_pag[88] = 'c_nazionedoc';
$var_pag[89] = 'c_regionedoc';
$var_pag[90] = 'c_cittadoc';
$var_pag[91] = 'c_cittanascita';
$var_pag[92] = 'c_regionenascita';
$var_pag[93] = 'c_nazionenascita';
$var_pag[94] = 'c_nazionalita';
$var_pag[95] = 'c_telefono';
$var_pag[96] = 'c_via';
$var_pag[97] = 'c_numcivico';
$var_pag[98] = 'c_citta';
$var_pag[99] = 'c_nazione';
$var_pag[100] = 'c_regione';
$var_pag[101] = 'c_cap';
$var_pag[102] = 'c_fax';
$var_pag[103] = 'c_email';
$var_pag[104] = 'c_email2';
$var_pag[105] = 'c_email_cert';
$var_pag[106] = 'c_lingua_cli';
$var_pag[107] = 'c_telefono2';
$var_pag[108] = 'c_telefono3';
$var_pag[109] = 'c_cod_fiscale';
$var_pag[110] = 'c_partita_iva';
$var_pag[111] = 'mese';
$n_var_pag = 112;
...
$idclienti = aggslashdb(fixset($idclienti));
...
$titolo = "HotelDruid: ".mex("Modifica Cliente",$pag);
...
if (isset($cancella_cliente) and $cancella_cliente == "SI") {
if ($continua == "SI") {
...
for ($num1 = 0 ; $num1 < $num_anni ; $num1++) {
$altre_tab_lock[$num_lock] = $PHPR_TAB_PRE."prenotacanc".risul_query($anni,$num1,'idanni');
$num_lock++;
} # fine for $num1
for ($num1 = 0 ; $num1 < $num_anni ; $num1++) {
...
$prenotazionicanc = esegui_query("select * from $tableprenotacanc_mostra where idclienti = '$idclienti'");
...
if (numlin_query($prenotazioni) != 0 or numlin_query($prenotazionicanc) != 0 or numlin_query($ospiti) != 0 or numlin_query($soldi) != 0) $prenota_cliente_esistente = "SI";
} # fine for $num1
...
} # fine if (isset($cancella_cliente) and $cancella_cliente == "SI")
...
$n_email2 = stripslashes($n_email2);
$n_email_cert = stripslashes($n_email_cert);
$n_fax = stripslashes($n_fax);
$n_commento = stripslashes($n_commento);
} # fine if (@get_magic_quotes_gpc())
$n_cognome = htmlspecialchars(fixstr($n_cognome));
$n_nome = htmlspecialchars(fixstr($n_nome));
$n_soprannome = htmlspecialchars(fixstr($n_soprannome));
$n_titolo_cli = htmlspecialchars(fixstr($n_titolo_cli));
if (!empty($n_sesso) and $n_sesso != "f") $n_sesso = "m";
$n_documento = htmlspecialchars(fixstr($n_documento));
$n_tipodoc = htmlspecialchars(fixstr($n_tipodoc));
$n_nazionedoc = htmlspecialchars(fixstr($n_nazionedoc));
$n_regionedoc = htmlspecialchars(fixstr($n_regionedoc));
$n_cittadoc = htmlspecialchars(fixstr($n_cittadoc));
$n_cittanascita = htmlspecialchars(fixstr($n_cittanascita));
$n_regionenascita = htmlspecialchars(fixstr($n_regionenascita));
$n_nazionenascita = htmlspecialchars(fixstr($n_nazionenascita));
$n_nazionalita = htmlspecialchars(fixstr($n_nazionalita));
$n_nazione = htmlspecialchars(fixstr($n_nazione));
$n_regione = htmlspecialchars(fixstr($n_regione));
$n_citta = htmlspecialchars(fixstr($n_citta));
$n_nomevia = htmlspecialchars(fixstr($n_nomevia));
$n_numcivico = htmlspecialchars(fixstr($n_numcivico));
$n_cap = htmlspecialchars(fixstr($n_cap));
$n_telefono = htmlspecialchars(fixstr($n_telefono));
$n_telefono2 = htmlspecialchars(fixstr($n_telefono2));
$n_telefono3 = htmlspecialchars(fixstr($n_telefono3));
$n_cod_fiscale = htmlspecialchars(fixstr($n_cod_fiscale));
$n_partita_iva = htmlspecialchars(fixstr($n_partita_iva));
$n_fax = htmlspecialchars(fixstr($n_fax));
$n_email = htmlspecialchars(fixstr($n_email));
$n_email2 = htmlspecialchars(fixstr($n_email2));
$n_email_cert = htmlspecialchars(fixstr($n_email_cert));
...
if (!$d_cap) $d_cap = "---";
if (!$d_email) $d_email = "---";
if (!$d_email2) $d_email2 = "---";
if (!$d_email_cert) $d_email_cert = "---";
...
$d_email2 = stripslashes($d_email2);
$d_email_cert = stripslashes($d_email_cert);
$d_nome_lingua = stripslashes($d_nome_lingua);
$d_commento = stripslashes($d_commento);
} # fine if (@get_magic_quotes_gpc())
$d_cognome = htmlspecialchars(fixstr($d_cognome));
$d_nome = htmlspecialchars(fixstr($d_nome));
$d_soprannome = htmlspecialchars(fixstr($d_soprannome));
$d_titolo_cli = htmlspecialchars(fixstr($d_titolo_cli));
$d_documento = htmlspecialchars(fixstr($d_documento));
$d_nazionedoc = htmlspecialchars(fixstr($d_nazionedoc));
$d_regionedoc = htmlspecialchars(fixstr($d_regionedoc));
$d_cittadoc = htmlspecialchars(fixstr($d_cittadoc));
$d_cittanascita = htmlspecialchars(fixstr($d_cittanascita));
$d_regionenascita = htmlspecialchars(fixstr($d_regionenascita));
$d_nazionenascita = htmlspecialchars(fixstr($d_nazionenascita));
$d_nazionalita = htmlspecialchars(fixstr($d_nazionalita));
$d_nazione = htmlspecialchars(fixstr($d_nazione));
$d_regione = htmlspecialchars(fixstr($d_regione));
$d_citta = htmlspecialchars(fixstr($d_citta));
$d_nomevia = htmlspecialchars(fixstr($d_nomevia));
$d_numcivico = htmlspecialchars(fixstr($d_numcivico));
$d_cap = htmlspecialchars(fixstr($d_cap));
$d_telefono = htmlspecialchars(fixstr($d_telefono));
$d_telefono2 = htmlspecialchars(fixstr($d_telefono2));
$d_telefono3 = htmlspecialchars(fixstr($d_telefono3));
$d_cod_fiscale = htmlspecialchars(fixstr($d_cod_fiscale));
$d_partita_iva = htmlspecialchars(fixstr($d_partita_iva));
$d_fax = htmlspecialchars(fixstr($d_fax));
$d_email = htmlspecialchars(fixstr($d_email));
$d_email2 = htmlspecialchars(fixstr($d_email2));
$d_email_cert = htmlspecialchars(fixstr($d_email_cert));
$d_nome_lingua = htmlspecialchars(fixstr($d_nome_lingua));
$d_commento = htmlspecialchars(fixstr($d_commento));

if ($n_cognome) {
echo mex("Il cognome verrà cambiato da",$pag)." <b>$d_cognome</b> ".mex("a",$pag)." <b>";
if ($attiva_prefisso_clienti == "p") echo $prefisso_clienti;
echo substr($n_cognome,0,70);
if ($attiva_prefisso_clienti == "s") echo $prefisso_clienti;
echo "</b>.<br>";
} # fine if ($n_cognome)
if ($n_nome) { echo mex("Il nome verrà cambiato da",$pag)." <b>$d_nome</b> ".mex("a",$pag)." <b>".substr($n_nome,0,70)."</b>.<br>"; }
if ($n_soprannome) { echo mex("Il soprannome verrà cambiato da",$pag)." <b>$d_soprannome</b> ".mex("a",$pag)." <b>".substr($n_soprannome,0,70)."</b>.<br>"; }
if ($n_titolo_cli) { echo mex("Il titolo verrà cambiato da",$pag)." <b>$d_titolo_cli</b> ".mex("a",$pag)." <b>".substr($n_titolo_cli,0,30)."</b>.<br>"; }
...
if ($n_telefono) { echo mex("Il telefono verrà cambiato da",$pag)." <b>$d_telefono</b> ".mex("a",$pag)." <b>".substr($n_telefono,0,50)."</b>.<br>"; }
...
if ($n_nazione) echo mex("La nazione di residenza verrà cambiata da",$pag)." <b>$d_nazione</b> ".mex("a",$pag)." <b>".substr($n_nazione,0,70)."</b>.<br>";
if ($n_regione) echo mex("La regione di residenza verrà cambiata da",$pag)." <b>$d_regione</b> ".mex("a",$pag)." <b>".substr($n_regione,0,70)."</b>.<br>";
if ($n_citta) echo mex("La città di residenza verrà cambiata da",$pag)." <b>$d_citta</b> ".mex("a",$pag)." <b>".substr($n_citta,0,70)."</b>.<br>";
if ($n_nomevia) {
include(C_DATI_PATH."/lingua.php");
if ($lingua_mex != "ita") include("./includes/lang/$lingua_mex/ordine_frasi.php");
if (isset($ordine_strada) and $ordine_strada == 2) $n_nvia = $n_nomevia . " " . $n_via;
else $n_nvia = $n_via . " " . $n_nomevia;
echo mex("La via  verrà cambiata da",$pag)." <b>$d_via</b> ".mex("a",$pag)." <b>".substr($n_nvia,0,70)."</b>.<br>";
} # fine if ($n_nomevia)
if ($n_numcivico) echo mex("Il numero civico verrà cambiato da",$pag)." <b>$d_numcivico</b> ".mex("a",$pag)." <b>".substr($n_numcivico,0,30)."</b>.<br>";
if ($n_cap) echo mex("Il CAP verrà cambiato da",$pag)." <b>$d_cap</b> ".mex("a",$pag)." <b>".substr($n_cap,0,30)."</b>.<br>";
if ($n_email) echo mex("L' email verrà cambiata da",$pag)." <b>$d_email</b> ".mex("a",$pag)." <b>$n_email</b>.<br>";
if ($n_email2) echo mex("La seconda email verrà cambiata da",$pag)." <b>$d_email2</b> ".mex("a",$pag)." <b>$n_email2</b>.<br>";
if ($n_email_cert) echo mex("L'email certificata (PEC) o il codice destinatario verrà cambiato da",$pag)." <b>$d_email_cert</b> ".mex("a",$pag)." <b>$n_email_cert</b>.<br>";
...
if ($n_fax) echo mex("Il fax verrà cambiato da",$pag)." <b>$d_fax</b> ".mex("a",$pag)." <b>".substr($n_fax,0,50)."</b>.<br>";
if ($n_telefono2) echo mex("Il 2° telefono verrà cambiato da",$pag)." <b>$d_telefono2</b> ".mex("a",$pag)." <b>".substr($n_telefono2,0,50)."</b>.<br>";
if ($n_telefono3) echo mex("Il 3° telefono verrà cambiato da",$pag)." <b>$d_telefono3</b> ".mex("a",$pag)." <b>".substr($n_telefono3,0,50)."</b>.<br>";
...
if (!empty($c_nome)) echo mex("Il <b>nome</b> verrà cancellato",$pag).".<br>";
if (!empty($c_soprannome)) echo mex("Il <b>soprannome</b> verrà cancellato",$pag).".<br>";
if (!empty($c_titolo_cli)) echo mex("Il <b>titolo</b> verrà cancellato",$pag).".<br>";
if (!empty($c_nazionalita)) echo mex("La <b>cittadinanza</b> verrà cancellata",$pag).".<br>";
if (!empty($c_telefono)) echo mex("Il <b>telefono</b> verrà cancellato",$pag).".<br>";
if (!empty($c_datanascita)) echo mex("La <b>data di nascita</b> verrà cancellata",$pag).".<br>";
if (!empty($c_nazionenascita)) echo mex("La <b>nazione di nascita</b> verrà cancellata",$pag).".<br>";
if (!empty($c_regionenascita)) echo mex("La <b>regione di nascita</b> verrà cancellata",$pag).".<br>";
if (!empty($c_cittanascita)) echo mex("La <b>città di nascita</b> verrà cancellata",$pag).".<br>";
if (!empty($c_nazione)) echo mex("La <b>nazione di residenza</b> verrà cancellata",$pag).".<br>";
if (!empty($c_regione)) echo mex("La <b>regione di residenza</b> verrà cancellata",$pag).".<br>";
if (!empty($c_citta)) echo mex("La <b>città di residenza</b> verrà cancellata",$pag).".<br>";
if (!empty($c_via)) echo mex("La <b>via</b> verrà cancellata",$pag).".<br>";
if (!empty($c_numcivico)) echo mex("Il <b>n° civico</b> verrà cancellato",$pag).".<br>";
if (!empty($c_cap)) echo mex("Il <b>CAP</b> verrà cancellato",$pag).".<br>";
if (!empty($c_email)) echo mex("L' <b>email</b> verrà cancellata",$pag).".<br>";
if (!empty($c_email2)) echo mex("La <b>seconda email</b> verrà cancellata",$pag).".<br>";
if (!empty($c_email_cert)) echo mex("L'<b>email certificata (PEC) o il codice destinatario</b> verrà cancellato",$pag).".<br>";
if (!empty($c_lingua_cli)) echo mex("La <b>lingua</b> verrà cancellata",$pag).".<br>";
if (!empty($c_documento)) echo mex("Il <b>documento</b> verrà cancellato",$pag).".<br>";
if (!empty($c_nazionedoc)) echo mex("La <b>nazione di rilascio del documento</b> verrà cancellata",$pag).".<br>";
if (!empty($c_regionedoc)) echo mex("La <b>regione/provincia di rilascio del documento</b> verrà cancellata",$pag).".<br>";
if (!empty($c_cittadoc)) echo mex("La <b>città di rilascio del documento</b> verrà cancellata",$pag).".<br>";
if (!empty($c_scadenzadoc)) echo mex("La <b>data di scadenza del documento</b> verrà cancellata",$pag).".<br>";
if (!empty($c_fax)) echo mex("Il <b>fax</b> verrà cancellato",$pag).".<br>";
if (!empty($c_telefono2)) echo mex("Il <b>2° telefono</b> verrà cancellato",$pag).".<br>";
if (!empty($c_telefono3)) echo mex("Il <b>3° telefono</b> verrà cancellato",$pag).".<br>";
if (!empty($c_cod_fiscale)) echo mex("Il <b>codice fiscale</b> verrà cancellato",$pag).".<br>";
if (!empty($c_partita_iva)) echo mex("La <b>partita iva</b> verrà cancellata",$pag).".<br>";

unset($d_campi_pers);
for ($num1 = 0 ; $num1 < $d_num_campi_pers ; $num1++) {
if (empty(${"n_campo_pers".$num1})) echo mex("Il campo",$pag)." \"<b>".${"d_campo_pers_nome".$num1}."</b>\" ".mex("verrà tolto",$pag).".<br>";
else {
...
<input type=\"hidden\" name=\"n_email2\" value=\"$n_email2\">
<input type=\"hidden\" name=\"n_email_cert\" value=\"$n_email_cert\">
...
for ($num1 = 0 ; $num1 < $num_campi_pers ; $num1++) echo "<input type=\"hidden\" name=\"campo_pers$num1\" value=\"".htmlspecialchars(fixstr(${"campo_pers".$num1}))."\">";


echo "<input type=\"hidden\" name=\"c_nome\" value=\"".htmlspecialchars(fixstr($c_nome))."\">
<input type=\"hidden\" name=\"c_soprannome\" value=\"".htmlspecialchars(fixstr($c_soprannome))."\">
<input type=\"hidden\" name=\"c_titolo_cli\" value=\"".htmlspecialchars(fixstr($c_titolo_cli))."\">
<input type=\"hidden\" name=\"c_datanascita\" value=\"".htmlspecialchars(fixstr($c_datanascita))."\">
<input type=\"hidden\" name=\"c_documento\" value=\"".htmlspecialchars(fixstr($c_documento))."\">
<input type=\"hidden\" name=\"c_scadenzadoc\" value=\"".htmlspecialchars(fixstr($c_scadenzadoc))."\">
<input type=\"hidden\" name=\"c_nazionedoc\" value=\"".htmlspecialchars(fixstr($c_nazionedoc))."\">
<input type=\"hidden\" name=\"c_regionedoc\" value=\"".htmlspecialchars(fixstr($c_regionedoc))."\">
<input type=\"hidden\" name=\"c_cittadoc\" value=\"".htmlspecialchars(fixstr($c_cittadoc))."\">
<input type=\"hidden\" name=\"c_cittanascita\" value=\"".htmlspecialchars(fixstr($c_cittanascita))."\">
<input type=\"hidden\" name=\"c_regionenascita\" value=\"".htmlspecialchars(fixstr($c_regionenascita))."\">
<input type=\"hidden\" name=\"c_nazionenascita\" value=\"".htmlspecialchars(fixstr($c_nazionenascita))."\">
<input type=\"hidden\" name=\"c_nazionalita\" value=\"".htmlspecialchars(fixstr($c_nazionalita))."\">
<input type=\"hidden\" name=\"c_telefono\" value=\"".htmlspecialchars(fixstr($c_telefono))."\">
<input type=\"hidden\" name=\"c_via\" value=\"".htmlspecialchars(fixstr($c_via))."\">
<input type=\"hidden\" name=\"c_numcivico\" value=\"".htmlspecialchars(fixstr($c_numcivico))."\">
<input type=\"hidden\" name=\"c_citta\" value=\"".htmlspecialchars(fixstr($c_citta))."\">
<input type=\"hidden\" name=\"c_nazione\" value=\"".htmlspecialchars(fixstr($c_nazione))."\">
<input type=\"hidden\" name=\"c_regione\" value=\"".htmlspecialchars(fixstr($c_regione))."\">
<input type=\"hidden\" name=\"c_cap\" value=\"".htmlspecialchars(fixstr($c_cap))."\">
<input type=\"hidden\" name=\"c_fax\" value=\"".htmlspecialchars(fixstr($c_fax))."\">
<input type=\"hidden\" name=\"c_email\" value=\"".htmlspecialchars(fixstr($c_email))."\">
<input type=\"hidden\" name=\"c_email2\" value=\"".htmlspecialchars(fixstr($c_email2))."\">
<input type=\"hidden\" name=\"c_email_cert\" value=\"".htmlspecialchars(fixstr($c_email_cert))."\">
<input type=\"hidden\" name=\"c_lingua_cli\" value=\"".htmlspecialchars(fixstr($c_lingua_cli))."\">
<input type=\"hidden\" name=\"c_telefono2\" value=\"".htmlspecialchars(fixstr($c_telefono2))."\">
<input type=\"hidden\" name=\"c_telefono3\" value=\"".htmlspecialchars(fixstr($c_telefono3))."\">
<input type=\"hidden\" name=\"c_cod_fiscale\" value=\"".htmlspecialchars(fixstr($c_cod_fiscale))."\">
<input type=\"hidden\" name=\"c_partita_iva\" value=\"".htmlspecialchars(fixstr($c_partita_iva))."\">
...
if (!empty($d_campi_pers['esist'][$opt[0]])) ${"campo_pers".$num1} = "";
...
if ($c_email2) {
esegui_query("update $tableclienti set email2 = '' where idclienti = '$idclienti' ");
} # fine if ($c_email2)
if ($c_email_cert) {
esegui_query("update $tableclienti set email3 = '' where idclienti = '$idclienti' ");
} # fine if ($c_email_cert)
if ($c_fax) {
...
} # fine if (!empty($modifica_cliente))
...
} # fine if (strcmp((string) $d_cvc_cc,""))
...
<tr style=\"background-color: ".rowbgcolor().";\"><td><table cellspacing=0 cellpadding=0><tr><td style=\"vertical-align: top;\">".mex("Numero",$pag).":&nbsp;</td><td>";
if ($d_num_cc) echo "<b>".substr($d_num_cc,0,4)."&nbsp;".substr($d_num_cc,4,4)."&nbsp;".substr($d_num_cc,8,4)."&nbsp;".substr($d_num_cc,12)."</b><br><div style=\"height: 4px;\"></div>$d_num_cc";
echo "</td></tr></table></td>
<td>".mex("cambia in",$pag).": 
...
$d_cognome = risul_query($cliente,0,'cognome');
$d_nome = (string) risul_query($cliente,0,'nome');
$d_soprannome = (string) risul_query($cliente,0,'soprannome');
$d_titolo_cli = risul_query($cliente,0,'titolo');
$d_sesso = risul_query($cliente,0,'sesso');
$d_scadenzadoc = (string) risul_query($cliente,0,'scadenzadoc');
if ($d_scadenzadoc) $d_scadenzadoc_f = formatta_data($d_scadenzadoc,$stile_data);
else $d_scadenzadoc_f = "";
if ($priv_vedi_indirizzo == "s") {
...
$d_email = (string) risul_query($cliente,0,'email');
$d_email2 = (string) risul_query($cliente,0,'email2');
$d_email_cert = (string) risul_query($cliente,0,'email3');
...
$d_email2_vedi = str_replace(",",", ",$d_email2);
$d_email2_vedi = "<b><a href=\"mailto:$d_email2\">$d_email2_vedi</a></b>";
if (strlen($d_email2) > 22) $d_email2_vedi = "<small>$d_email2_vedi</small>";
echo "<tr style=\"background-color: ".rowbgcolor().";\"><td>".mex("2ª email",$pag).": $d_email2_vedi</td>
<td>".mex("cambia in",$pag).": 
<input type=\"text\" name=\"n_email2\" size=\"30\">
<br><label><input type=\"checkbox\" name=\"c_email2\" value=\"SI\">".mex("cancella",$pag)."</label></td></tr>";
if (strstr($d_email_cert,"@")) $d_email_cert_vedi = "<b><a href=\"mailto:$d_email_cert\">".str_replace(",",", ",$d_email_cert)."</a></b>";
else $d_email_cert_vedi = "<b>$d_email_cert</b>";
if (strlen($d_email_cert) > 22) $d_email_cert_vedi = "<small>$d_email_cert_vedi</small>";
echo "<tr style=\"background-color: ".rowbgcolor().";\"><td>".mex("PEC o codice destinatario",$pag).": $d_email_cert_vedi</td>
<td>".mex("cambia in",$pag).": 
<input type=\"text\" name=\"n_email_cert\" size=\"30\">
<br><label><input type=\"checkbox\" name=\"c_email_cert\" value=\"SI\">".mex("cancella",$pag)."</label></td></tr>";
} # fine if ($priv_vedi_telefoni == "s")
...
for ($num1 = 0 ; $num1 < $num_campi_pers ; $num1++) {
$opt = explode("<",$campi_pers[$num1]);
if (empty($d_campi_pers['esist'][$opt[0]])) {
...
} # fine if (empty($d_campi_pers['esist'][$opt[0]]))
} # fine for $num1
...
<input type=\"hidden\" name=\"d_email2\" value=\"$d_email2\">
<input type=\"hidden\" name=\"d_email_cert\" value=\"$d_email_cert\">
...
<input type=\"hidden\" name=\"idclienti\" value=\"$idclienti\">
<input type=\"hidden\" name=\"origine_vecchia\" value=\"".htmlspecialchars(fixstr($origine))."\">
...
<input type=\"hidden\" name=\"email2_1\" value=\"$d_email2\">
<input type=\"hidden\" name=\"email_certificata_1\" value=\"$d_email_cert\">
...
$tableprencanc_m = $PHPR_TAB_PRE."prenotacanc".$anno_mostra;
...
$prenotazioni_canc = esegui_query("select distinct $tableprencanc_m.idprenota,$tableprencanc_m.idclienti,$tableprencanc_m.utente_inserimento,$tableprencanc_m.idappartamenti,$tableprencanc_m.commento,$tableprencanc_m.iddatainizio,$tableprencanc_m.iddatafine,$tableprencanc_m.num_persone,$tableprencanc_m.caparra,$tableprencanc_m.pagato,$tableprencanc_m.tariffa_tot,$tableprencanc_m.datainserimento from $tableprencanc_m left outer join $tablerclipren_m on $tableprencanc_m.idprenota = $tablerclipren_m.idprenota where $tableprencanc_m.idclienti = '$idclienti' or $tablerclipren_m.idclienti = '$idclienti' ");
$soldi = esegui_query("select * from $tablesoldi_mostra where motivazione $LIKE '$idclienti".";%'");
...
if ($num_prenotazioni != 0 or $num_prenotazioni_canc != 0) {
...
for ($num2 = 0 ; $num2 < ($num_prenotazioni + $num_prenotazioni_canc) ; $num2 = $num2 + 1) {
if ($num2 == $num_prenotazioni) {
chiudi_query($prenotazioni);
$prenotazioni = $prenotazioni_canc;
$tablepren_m = $tableprencanc_m;
$classcanc = " class=\"bcoldeleted\"";
$stilebarrato = " style=\"text-decoration: line-through\"";
$cancval = "&amp;pcanc=1";
$ini_q = $num_prenotazioni;
} # fine if ($num2 == $num_prenotazioni)

$utente_inserimento_prenota = risul_query($prenotazioni,($num2 - $ini_q),'utente_inserimento',$tablepren_m);
...
$numero = risul_query($prenotazioni,($num2 - $ini_q),'idprenota',$tablepren_m);
$appartamento = risul_query($prenotazioni,($num2 - $ini_q),'idappartamenti',$tablepren_m);
$commento = (string) risul_query($prenotazioni,($num2 - $ini_q),'commento',$tablepren_m);
if (strstr($commento,">")) {
...
$id_data_inizio = risul_query($prenotazioni,($num2 - $ini_q),'iddatainizio',$tablepren_m);
...
$id_data_fine = risul_query($prenotazioni,($num2 - $ini_q),'iddatafine',$tablepren_m);
...
$num_persone = risul_query($prenotazioni,($num2 - $ini_q),'num_persone',$tablepren_m);
...
$caparra = risul_query($prenotazioni,($num2 - $ini_q),'caparra',$tablepren_m);
if (!$caparra) { $caparra = 0; }
$caparra_p = punti_in_num($caparra,$stile_soldi);
$pagato = risul_query($prenotazioni,($num2 - $ini_q),'pagato',$tablepren_m);
if (!$pagato) { $pagato = 0; }
$pagato_p = punti_in_num($pagato,$stile_soldi);
$costo_tot = risul_query($prenotazioni,($num2 - $ini_q),'tariffa_tot',$tablepren_m);
...
$data_ins = risul_query($prenotazioni,($num2 - $ini_q),'datainserimento',$tablepren_m);
...
$id_cli_pren = risul_query($prenotazioni,($num2 - $ini_q),'idclienti',$tablepren_m);
...
echo "<tr$classcanc><td><a$stilebarrato href=\"modifica_prenota.php?id_prenota=$numero$cancval&amp;anno=$anno&amp;id_sessione=$id_sessione&amp;origine=modifica_cliente.php?idclienti=$idclienti\">$numero</a></td>";
} # fine if ($anno = $anno_mostra)
else { echo "<tr$classcanc><td$stilebarrato>$numero</td>"; }
echo "<td>$cognome_pren</td>
<td>$data_inizio_f";
if (!$mobile_device) echo "</td><td>";
else echo "&nbsp;/&nbsp;<span class=\"smlscr\"> </span>";
echo "$data_fine_f</td>
<td$stilebarrato>$costo_tot_p</td>
<td$class_opt$stilebarrato>$caparra_p</td>
<td";
...
if (!$stilebarrato) $costo_tot_TOT = $costo_tot_TOT + $costo_tot;
if (!$stilebarrato) $caparra_TOT = $caparra_TOT + $caparra;
...
echo "</table></div><br>";
} # fine if ($num_prenotazioni != 0 or $num_prenotazioni_canc != 0)
} # fine for $num1
...
} # fine if (!isset($mostra_form_modifica_cliente) or $mostra_form_modifica_cliente != "NO")

...
$titolo = "IdealVilla: Interconnession";
...
function variabili_x_form (&$lista_tutti_app,&$maxocc,&$lista_regola2,&$lista_regola4,&$origini_prenota,&$campi_pers_comm,$tableappartamenti,$tableregole,$tablepersonalizza) {
...
variabili_x_form($lista_tutti_app,$maxocc,$lista_regola2,$lista_regola4,$origini_prenota,$campi_pers_comm,$tableappartamenti,$tableregole,$tablepersonalizza);

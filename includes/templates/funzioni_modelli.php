...
if (empty($tablepersonalizza)) $tablepersonalizza = $PHPR_TAB_PRE."personalizza";
...
$num_vett_tmp++;
if (isset($perc_cart_mod_sel) and $percorso_cartella_modello == $perc_cart_mod_sel) break;
...
$input_utente = str_replace("\\\\","\\",(string) $input_utente);
...
if (strcmp((string) $percorso_cartella_dominio,"") and substr($percorso_cartella_dominio,-1) != "/") $percorso_cartella_dominio .= "/";

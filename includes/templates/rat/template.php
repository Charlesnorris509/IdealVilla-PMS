...
if (isset($tariffe_mostra[$num1]) and $tariffe_mostra[$num1] == "SI") {
$num_tariffe_mostra++;
...
if (!empty($n_tariffe_imposte[$num1])) $nometariffa_vedi[$num_tariffe_mostra] = $n_tariffe_imposte[$num1];
...
} # fine if (isset($tariffe_mostra[$num1]) and $tariffe_mostra[$num1] == "SI")
} # fine for $num1
...
if (!empty($dati_tariffe[$tariffa[$num1]]['chiusa'][($inizioperiodi_id[$num_p] + 1)])) {
$tariffa_colonna_periodo[$num1][$num_colonne_periodi] = "c";
$tariffap_colonna_periodo[$num1][$num_colonne_periodi] = "c";
} # fine if (!empty($dati_tariffe[$tariffa[$num1]]['chiusa'][($inizioperiodi_id[$num_p] + 1)]))
...
if (!empty($dati_tariffe[$tariffa[$num2]]['chiusa'][($num1 + 1)])) {
${$tariffa[$num2]} = "c";
${$tariffa[$num2]."p"} = "c";
} # fine if (!empty($dati_tariffe[$tariffa[$num2]]['chiusa'][($num1 + 1)]))
for ($num_i = 1 ; $num_i < $intervalloperiodi[$num_p] ; $num_i++) {
...
if (isset($costi_agg_mostra[$idcostoagg]) and $costi_agg_mostra[$idcostoagg] == "SI") {
...
$testo_costi_agg .= "<li>$apertura_tag_font <b>$nomecosto_imposto</b>:";
...
} # fine if (isset($costi_agg_mostra[$idcostoagg]) and $costi_agg_mostra[$idcostoagg] == "SI")
} # fine for $numca

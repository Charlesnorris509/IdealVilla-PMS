...
define('C_MASSIMO_NUM_UTENTI',80);
define('C_MASSIMO_NUM_CLIENTI',120000);
define('C_MASSIMO_NUM_TARIFFE',180);
define('C_MASSIMO_NUM_CONTRATTI',90);
define('C_MASSIMO_NUM_COSTI_AGG',1500);
define('C_MASSIMO_NUM_COSTI_AGG_IN_PRENOTA',250);
define('C_MASSIMO_NUM_STORIA_SOLDI',140000);
define('C_MASSIMO_NUM_COSTI',90000);
define('C_MASSIMO_NUM_APP',0);
define('C_MASSIMO_NUM_BYTE_UPLOAD',12582912);
define('C_MASSIMO_NUM_EMAIL_GIORNALIERE',200); # NUM + (10%NUM * NUM_APP)
define('C_CREA_ULTIMO_ACCESSO',"SI");
#if (!defined('C_CARTELLA_CREA_MODELLI')) define('C_CARTELLA_CREA_MODELLI',"");
#if (!defined('C_URL_CREA_MODELLI')) define('C_URL_CREA_MODELLI',"");
#if (!defined('C_PERCORSO_PHPMAILER')) define('C_PERCORSO_PHPMAILER',"");
...
# può essere SI, NO o "spf: ..." con i campi spf (separati da spazi) che devono esistere nel dominio dell'email da mascherare
if (!defined('C_MASCHERA_EMAIL')) define('C_MASCHERA_EMAIL',"");
...
define('C_FILE_DOMINIO',""); # secure domains file will be searched as C_FILE_DOMINIO.'_https'

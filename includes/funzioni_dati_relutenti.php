...
if (strcmp((string) $codice,"")) echo " ($codice)";
if (strcmp((string) $codice2,"")) echo " (".mex("2°",'personalizza.php')." $codice2)";
if (strcmp((string) $codice3,"")) echo " (".mex("3°",'personalizza.php')." $codice3)";
} # fine if ($mostra_cod)
echo "</option>";
} # fine for $num1
echo "</select>";

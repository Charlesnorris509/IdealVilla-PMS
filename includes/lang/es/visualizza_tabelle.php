...
case "Converti definitivamente in":  		$messaggio = "Convertir definitivamente en"; break;
case "al cambio attuale":  			$messaggio = "al cambio actual"; break;
case "Le altre valute presenti nella cassa":  	$messaggio = "Las otras divisas presentes en la caja"; break;
case "sono state convertite in":  		$messaggio = "han sido convertidas en"; break;
case "Tabella con le prenotazioni cancellate":	$messaggio = "Tabla con las reservas borradas"; break;
case "Prenotazioni cancellate":  		$messaggio = "Reservas borradas"; break;
case "<b>non importare</b> i prezzi":  		$messaggio = "<b>sin importar</b> los precios"; break;
case "Attenzione":  				$messaggio = "Aviso"; break;
case "i periodi aggiunti non potranno più essere eliminati":	$messaggio = "los períodos añadidos ya no podrán ser eliminados"; break;
case "come tipo di persona":  			$messaggio = "como tipo de persona"; break;
case "e applica la % del tipo di persona":  	$messaggio = "y aplicar el % del tipo de persona"; break;
case "escludendo":  				$messaggio = "excluyendo"; break;
case "includendo solo":  			$messaggio = "incluyendo solo"; break;
case "e":  					$messaggio = "y"; break;
case "Superato il massimo numero di anni comparabili":	$messaggio = "Superado el número máximo de años comparables"; break;

...
if ($dati_app['maxocc'][$numapp] >= $num_persone and (empty($app_richiesti) or (isset($app_richiesti[$numapp]) and $app_richiesti[$numapp] == "SI"))) {
...
} # fine if ($dati_app['maxocc'][$numapp] >= $num_persone and (empty($app_richiesti) or...
} # fine for $num1

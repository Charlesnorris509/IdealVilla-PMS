...
$titolo = "IdealVilla: Source Code";

$var_pag = array();
$var_pag[0] = 'file_sorgente';
$var_pag[1] = 'raw';
$n_var_pag = 2;
...
if (!empty($file_sorgente) and substr($file_sorgente,-1) != "/") {
$file_trovato = "NO";
...
else echo "<div style=\"word-break: break-word; line-height: 1.2;\">".nl2br(htmlspecialchars($file_sorgente))."</div>";
} # fine else if (substr($file_sorgente,-4) == ".png" or...
} # fine if (@is_file($file_sorgente))
} # fine if ($file_trovato == "SI")
} # fine if (!empty($file_sorgente) and...

...
$titolo = "IdealVilla: Personaliser";
$base_js = 1;
...
$var_pag[261] = 'therad_email_tm0';
$var_pag[262] = 'mittente_email_tm0';
$var_pag[263] = 'oggetto_email_tm0';
$var_pag[264] = 'num_trova_email_tm';
$var_pag[265] = 'n_num_righe_tab_casse';
$var_pag[266] = 'cambia_righe_casse';
$var_pag[267] = 'tot_giornalero_tab_casse';
$var_pag[268] = 'tot_mensile_tab_casse';
$var_pag[269] = 'tot_tab_casse';
$var_pag[270] = 'cambia_tot_giornalero_tab_casse';
$var_pag[271] = 'n_num_righe_tab_storia_soldi';
$var_pag[272] = 'cambia_righe_storia_soldi';
$var_pag[273] = 'n_ordine_inventario';
$var_pag[274] = 'cambia_ordine_inventario';
$var_pag[275] = 'num_tasti_pos';
$var_pag[276] = 'cambia_tasti_pos';
$var_pag[277] = 'n_num_righe_tab_doc_salvati';
$var_pag[278] = 'cambia_righe_doc_salvati';
$var_pag[279] = 'utente_importa_contratti';
$var_pag[280] = 'importa_nomi_contratti';
$var_pag[281] = 'disattiva_assegnazione_automatica';
$var_pag[282] = 'attiva_assegnazione_automatica';
$var_pag[283] = 'secondi_lim_liberasett';
$var_pag[284] = 'cambia_secondi_lim_liberasett';
$var_pag[285] = 'disattiva_auto_crea_anno';
$var_pag[286] = 'attiva_auto_crea_anno';
$var_pag[287] = 'disattiva_phpr_log';
$var_pag[288] = 'id_utente_log';
$var_pag[289] = 'attiva_phpr_log';
$var_pag[290] = 'minuti_durata_insprenota';
$var_pag[291] = 'cambia_minuti_durata_insprenota';
$var_pag[292] = 'ore_diff_server';
$var_pag[293] = 'cambia_ore_diff_server';
$var_pag[294] = 'maschera_email';
$var_pag[295] = 'cambia_maschera_email';
$n_var_pag = 296;
$num2 = 0;
...
for ($num4 = 2 ; $num4 <= $num5 ; $num4++) $var_pag[$n_var_pag++] = "perc_cat_$num4";
if ($num2) {
$num2 = explode(",",$num2);
$num3 = count($num2);
...
<input type=\"hidden\" name=\"percorso_cartella_modello\" value=\"".htmlspecialchars($percorso_cartella_modello_int)."\">
...
} # fine else if ($canc_mod and !$continua)
...
if (!$aggiorna) echo "<br>".mex("I dati per il collegamento al server SMTP sono <span class=\"colred\">sbagliati o incompleti</span>",$pag).".<br><br>";
else {
...
else echo "<em>".htmlspecialchars($spf_pre.$spf_val." ".$spf)."</em><br>";
...
if ($id_utente == 1 or ($priv_crea_backup == "s" and $installazione_subordinata != "SI") or $priv_crea_pagineweb == "s" or ($priv_crea_interconnessioni == "s" and (!defined('C_CREA_SUBORDINAZIONI') or C_CREA_SUBORDINAZIONI != "NO"))) {
...
$Plur.&nbsp;\"<em>".str_replace(" ","&nbsp;",$nomi_corr[1])."</em>\"<small></td>";
} # fine if ($priv_modpers_cat_pers == "n")
else {
echo "<td>$Sing.<input type=\"text\" name=\"nome_sing_".$l_ling[$num2]."_$num1\" size=\"9\" value=\"".$nomi_corr[0]."\"><br>
$Plur.<input type=\"text\" name=\"nome_plur_".$l_ling[$num2]."_$num1\" size=\"9\" value=\"".$nomi_corr[1]."\"></td>";
} # fine else if ($priv_modpers_cat_pers == "n")
} # fine for $num2
echo "</tr>";
} # fine for $num1
